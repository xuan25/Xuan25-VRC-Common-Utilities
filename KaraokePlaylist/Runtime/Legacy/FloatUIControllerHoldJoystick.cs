...
namespace Playlist {
    ...
    public class FloatUIControllerHoldJoystick : UdonSharpBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                if (Input.GetKey(KeyCode.E) || currentRightVerticalValue > 0.9f)
        ...
        {
            if (InputManager.GetLastUsedInputMethod() != VRCInputMethod.Mouse && args.handType == VRC.Udon.Common.HandType.RIGHT)
                currentRightVerticalValue = args.floatValue;
            else
